...
use crate::domain::{
    ...
    AccidentalScoringParams, AspectDefinition, ChartObject, HouseAxisReference, HouseReference,
...
pub use crate::astrology::validation::validate_calculation_references;
