...
Add-ReportLine "- POST /v1/internal/calculations/validate"
Add-ReportLine "- POST /v1/internal/calculations/natal"
Add-ReportLine "- POST /v1/internal/calculations/natal/simplified"
Add-ReportLine "- POST /v1/internal/calculations/horoscope/daily-natal"
Add-ReportLine ""
