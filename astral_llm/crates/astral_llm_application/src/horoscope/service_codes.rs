...
pub(crate) const PERIOD_V2_QUALITY_MAX_RETRIES: usize = 1;
pub(crate) const PERIOD_V2_MAX_OUTPUT_TOKENS: u32 = 12_000;
pub(crate) const PERIOD_V2_EDITOR_MAX_OUTPUT_TOKENS: u32 = 8_000;
