    ...
    let registry = ModelCapabilityRegistry::from_db_catalog(
        ...
        vec![
            ...
            ModelCapability {
                ...
                api_model_id: Some("gpt-5.4".into()),
...
fn subtask_tier_allowed_for_summary_context() {
    let registry = ModelCapabilityRegistry::from_db_catalog(
        ...
        vec![ModelCapability {
            ...
            api_model_id: Some("gpt-5-nano".into()),
            supports_json_schema_strict: true,
            supports_json_object: true,
            supports_reasoning_effort: true,
            supports_streaming: true,
...
fn row_mapping_sets_anthropic_native_safety() {
    ...
    let row = LlmProviderModelRow {
        ...
        model_code: Some("claude-sonnet-4-20250514".into()),
        display_name: Some("Claude Sonnet 4".into()),
        api_model_id: Some("claude-sonnet-4-20250514".into()),
        catalog_notes: None,
        supports_json_schema_strict: true,
        supports_json_object: true,
        ...
        usage_tier_code: Some("production_candidate".into()),
        input_price_usd_per_mtok: Some(3.0),
        output_price_usd_per_mtok: Some(15.0),
        cache_read_price_usd_per_mtok: Some(0.3),
        cache_write_price_usd_per_mtok: Some(3.75),
        reasoning_price_usd_per_mtok: None,
        pricing_currency: Some("USD".into()),
        pricing_source: Some("https://platform.claude.com/docs/en/about-claude/pricing".into()),
...
fn production_openai_gpt41() -> ModelCapability {
    ModelCapability {
        ...
        api_model_id: Some("gpt-4.1".into()),
        supports_json_schema_strict: true,
        supports_json_object: true,
        supports_reasoning_effort: false,
        supports_streaming: true,
...
fn oracle_gpt55_pro() -> ModelCapability {
    ModelCapability {
        ...
        display_name: Some("GPT-5.5 Pro".into()),
        api_model_id: Some("gpt-5.5-pro".into()),
        supports_json_schema_strict: true,
        supports_json_object: true,
        supports_reasoning_effort: true,
