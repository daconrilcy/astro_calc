...
fn bootstrap_chapter_slots() -> Vec<ChapterEvidenceSlot> {
    let rows: &[(&str, EvidenceSlotRole, Option<&str>, Option<&str>, Option<u8>, i32, u8, bool)] = &[
        ...
        ("relationships", EvidenceSlotRole::Core, Some("house_ruler"), Some("descendant"), None, 30, 1, true),
        ...
        ("career", EvidenceSlotRole::Core, Some("house_ruler"), Some("mc"), None, 30, 1, true),
        ...
        ("career", EvidenceSlotRole::Nuance, Some("essential_dignity"), None, None, 80, 1, false),
        ("resources", EvidenceSlotRole::Core, Some("placement"), None, Some(2), 10, 1, true),
        ("resources", EvidenceSlotRole::Core, Some("house_ruler"), None, Some(2), 20, 1, true),
        ("resources", EvidenceSlotRole::Supporting, Some("placement"), Some("sun"), None, 30, 1, false),
        ("resources", EvidenceSlotRole::Supporting, Some("placement"), Some("saturn"), None, 40, 1, false),
        ("resources", EvidenceSlotRole::Supporting, Some("house_emphasis"), None, Some(2), 50, 1, false),
        ("resources", EvidenceSlotRole::Supporting, Some("essential_dignity"), None, None, 60, 1, false),
        ("resources", EvidenceSlotRole::Nuance, Some("accidental_dignity"), None, None, 70, 1, false),
        ("family_roots", EvidenceSlotRole::Core, Some("placement"), None, Some(4), 10, 1, true),
        ("family_roots", EvidenceSlotRole::Core, Some("angle"), Some("ic"), Some(4), 20, 1, false),
        ("family_roots", EvidenceSlotRole::Supporting, Some("placement"), Some("moon"), None, 30, 1, true),
        ("family_roots", EvidenceSlotRole::Supporting, Some("house_ruler"), None, Some(4), 40, 1, true),
        ("family_roots", EvidenceSlotRole::Supporting, Some("aspect"), None, None, 50, 2, false),
        ("family_roots", EvidenceSlotRole::Nuance, Some("lunar_phase"), None, None, 60, 1, false),
        ("communication_mind", EvidenceSlotRole::Core, Some("placement"), Some("mercury"), None, 10, 1, true),
        ("communication_mind", EvidenceSlotRole::Core, Some("placement"), None, Some(3), 20, 1, true),
        ("communication_mind", EvidenceSlotRole::Supporting, Some("house_ruler"), None, Some(3), 30, 1, true),
        ("communication_mind", EvidenceSlotRole::Supporting, Some("aspect"), None, None, 40, 2, false),
        ("communication_mind", EvidenceSlotRole::Supporting, Some("placement"), Some("venus"), None, 50, 1, false),
        ("communication_mind", EvidenceSlotRole::Nuance, Some("planetary_condition"), None, None, 60, 1, false),
        ...
        ("growth_path", EvidenceSlotRole::Nuance, Some("aspect"), None, None, 70, 1, false),
        ("synthesis", EvidenceSlotRole::Core, Some("dominant_planet"), None, None, 10, 2, true),
        ("synthesis", EvidenceSlotRole::Core, Some("element_balance"), None, None, 20, 1, true),
        ("synthesis", EvidenceSlotRole::Supporting, Some("modality_balance"), None, None, 30, 1, false),
        ("synthesis", EvidenceSlotRole::Supporting, Some("house_emphasis"), None, None, 40, 2, false),
        ("synthesis", EvidenceSlotRole::Supporting, Some("aspect"), None, None, 50, 2, false),
        ("synthesis", EvidenceSlotRole::Nuance, Some("house_axis"), None, None, 60, 1, false),
        ("synthesis", EvidenceSlotRole::Nuance, Some("sect_condition"), None, None, 70, 1, false),
    ];
    rows.iter()
...
fn bootstrap_requirements() -> Vec<EvidenceRequirement> {
    vec![
        ...
        EvidenceRequirement {
            ...
            accepted_kind_codes: vec!["placement".into(), "house_ruler".into(), "house_emphasis".into()],
            accepted_object_codes: vec![],
