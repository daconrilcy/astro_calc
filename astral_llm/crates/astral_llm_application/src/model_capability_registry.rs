...
fn fake_capability() -> ModelCapability {
    ModelCapability {
        ...
        input_price_usd_per_mtok: Some(0.0),
        output_price_usd_per_mtok: Some(0.0),
        cache_read_price_usd_per_mtok: Some(0.0),
        cache_write_price_usd_per_mtok: Some(0.0),
        reasoning_price_usd_per_mtok: Some(0.0),
        pricing_currency: Some("USD".into()),
        pricing_source: Some("bootstrap".into()),
    }
}
